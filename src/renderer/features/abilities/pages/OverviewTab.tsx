...
import { abilitiesNeedingAttention, abilityStats, abilityStatusPresentation, recentlyInstalledAbilities, SOURCE_LABELS } from '../ability-view'
...
export function OverviewTab({ abilities, onOpen }: { abilities: Ability[]; onOpen: (ability: Ability) => void }) {
  ...
  return <div className="cap-tab-content">
    ...
    <section className="cap-overview-section">
      ...
      <p className="cap-overview-hint">能力被 Agent 实际调用后，这里会按时间展示最近使用的 Skill 与 MCP Tool。</p>
    </section>
  </div>
}
